// tests/Item/POST/createItem.js
require('dotenv').config();
const axios = require('axios');

// Secrets / env-config (keep out of code)
...
// Your request payload (edit as needed)
const body = {
    name: 'samsung 17',
...
(async () => {
    try {
        const res = await http.post('/items/', body);
        console.dir(res.data, { depth: null, colors: true });

        // Normalize response shapes: {data: {...}} | {data: [...]} | {...}
        ...
        // Render a table if we have something that looks like an item
